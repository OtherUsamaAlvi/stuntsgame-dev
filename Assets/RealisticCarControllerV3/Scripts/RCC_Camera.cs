...
//		transform.rotation = playerCar.transform.rotation * Quaternion.AngleAxis(10f, Vector3.right);
	...
	public void changeCameraToFixed()
	{
	...
	public void changeCameraToCinematic()
	{
	...
	public void TPSZoomOut(float minFov)
    {
		
		float temp;
        temp = minFov;
		TPSMaximumFOV = 100f;
		while(TPSMinimumFOV<= temp)
        {
			TPSMinimumFOV += 0.01f;
		}
