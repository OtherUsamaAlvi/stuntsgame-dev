...
public class RCC_CarControllerV3 : RCC_Core {
	...
	private bool isReverseing=false;         // Tell If car is in reverse
	...
	#region Damage
	// Damage.
	private bool resetCarWhenFliped = true;										// Reset Car when car is flipped
	...
	public bool usingNOS = false;                           //IfCarIsUsingNos
	...
	/// <summary>
	/// Sets and Gets If we want RCC to Reset the car when car is flipped
	/// if state is false car will not be flipped
	/// </summary>
	/// <param name="state"></param>
	public void SetresetCarWhenFliped(bool state)
    {
		resetCarWhenFliped = state;

	}
	public bool GetresetCarWhenFliped()
	{
		return resetCarWhenFliped;
